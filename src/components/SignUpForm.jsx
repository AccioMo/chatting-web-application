		...
		<div>
			...
			<form onSubmit={handleSubmit(logUserIn)} className='login-form'>
				<div className="input-field">
					...
					<input className='login-input' type="name" id="full_name" {...register("fullName")} />
				</div>
				<div className="input-field">
				...
				<div className="input-field">
					...
					<input className='login-input' type="email" id="email" {...register("email")} />
				</div>
				<div className="input-field">
				...
				<div className="input-field">
					...
					<input className='login-input' type="password" id="passwordConfirm" {...register("passwordConfirm")} />
				</div>
				<div className="input-field">
